    ...
    <div className='flex justify-between items-center p-3 bg-slate-200 rounded-md'>
      ...
      <div className='flex items-center gap-4'>
        ...
        <div className="rounded-lg w-[14rem] h-[34px] overflow-hidden flex">
          <input type="text" placeholder="Search..." className="w-[85%] font-medium rounded-l-lg outline-0 border-2 border-slate-300 bg-slate-100 text-primary-dark text-sm caret-bg-primary px-4 placeholder:text-primary-dark placeholder:text-sm" />
