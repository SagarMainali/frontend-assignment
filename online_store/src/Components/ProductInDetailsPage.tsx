...
export function ProductInDetailsPage(props: ProductType) {
     return (
          <div className="flex md:flex-row flex-col justify-center items-center gap-6 max-w-[1300px] mx-auto">
               ...
               <div className="flex flex-col gap-4">
                    ...
                    <button className="border-2 border-primary-dark rounded-md flex items-center gap-2 py-1.5 px-4 mr-auto group hover:scale-[.98] hover:bg-primary-dark duration-300">
