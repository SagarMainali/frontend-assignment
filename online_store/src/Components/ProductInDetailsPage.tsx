...
export function ProductInDetailsPage(props: ProductType) {
     ...
     return (
          <div className="flex md:flex-row flex-col justify-center md:items-start items-center gap-6 max-w-[1300px] mx-auto">
               <div className="border-2 border-slate-300 rounded-lg p-6 group overflow-hidden cursor-pointer">
                    <img src={props.image} alt="product-image" className="max-h-[500px] object-cover group-hover:scale-[.80] duration-[450ms]" />
               </div>
               ...
               <div className="flex flex-col gap-4">
                    ...
                    {/* <div className="flex gap-4 items-center">
                         ...
                         <svg className="cursor-pointer" xmlns="http://www.w3.org/2000/svg" height="1rem" fill='#001C30' viewBox="0 0 448 512">
                    ...
                    <button onClick={() => addToCart(props)} className="border-2 border-primary-dark rounded-md flex items-center gap-2 py-1.5 px-4 mr-auto group hover:scale-[.98] hover:bg-primary-dark duration-300">
